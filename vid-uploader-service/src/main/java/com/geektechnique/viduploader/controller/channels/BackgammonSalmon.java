...
@ConditionalOnProperty(
        value = "backgammon-salmon.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/backgammon-salmon")
public class BackgammonSalmon extends BaseVideoController {
    public BackgammonSalmon() {
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "backgammon-salmon",
                                "/home/pi/vid-upload/backgammon-salmon/.client_secret.json",
                                "/home/pi/vid-upload/backgammon-salmon/.youtube-upload-credentials.json"
                        )
                )
        );
    }
