...
@ConditionalOnProperty(
        value = "final-ignition.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/final-ignition")
public class FinalIgnition extends BaseVideoController {
    public FinalIgnition() {
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "final-ignition",
                                "/home/pi/vid-upload/final-ignition/.client_secret.json",
                                "/home/pi/vid-upload/final-ignition/.youtube-upload-credentials.json"
                        )
                )
        );
    }
