...
@ConditionalOnProperty(
        value = "see-reversi.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/see-reversi")
public class SeeReversi extends BaseVideoController {
    public SeeReversi() {
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "see-reversi",
                                "/home/pi/vid-upload/see-reversi/.client_secret.json",
                                "/home/pi/vid-upload/see-reversi/.youtube-upload-credentials.json"
                        )
                )
        );
    }
