...
@ConditionalOnProperty(
        value = "scrabble-babble.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/scrabble-babble")
public class ScrabbleBabble extends BaseVideoController {
        ...
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "scrabble-babble",
                                "/home/pi/vid-upload/scrabble-babble/.client_secret.json",
                                "/home/pi/vid-upload/scrabble-babble/.youtube-upload-credentials.json"
                        )
                )
        );
    }
