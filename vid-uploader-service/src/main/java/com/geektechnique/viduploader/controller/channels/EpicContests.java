...
@ConditionalOnProperty(
        value = "epic-contests.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/epic-contests")
public class EpicContests extends BaseVideoController {
    public EpicContests() {
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "epic-contests",
                                "/home/pi/vid-upload/epic-contests/.client_secret.json",
                                "/home/pi/vid-upload/epic-contests/.youtube-upload-credentials.json"
                        )
                )
        );
    }
