...
@ConditionalOnProperty(
        value = "fluorescent-heart.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/fluorescent-heart")
public class FluorescentHeart extends BaseVideoController {
    public FluorescentHeart() {
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "fluorescent-heart",
                                "/home/pi/vid-upload/fluorescent-heart/.client_secret.json",
                                "/home/pi/vid-upload/fluorescent-heart/.youtube-upload-credentials.json"
                        )
                )
        );
    }
