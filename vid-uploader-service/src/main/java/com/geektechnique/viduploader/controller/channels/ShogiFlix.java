...
@ConditionalOnProperty(
        value = "shogi-flix.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/shogi-flix")
public class ShogiFlix extends BaseVideoController {
    public ShogiFlix() {
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "shogi-flix",
                                "/home/pi/vid-upload/shogi-flix/.client_secret.json",
                                "/home/pi/vid-upload/shogi-flix/.youtube-upload-credentials.json"
                        )
                )
        );
    }
