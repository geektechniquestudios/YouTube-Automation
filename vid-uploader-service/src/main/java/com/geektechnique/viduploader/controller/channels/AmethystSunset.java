...
@ConditionalOnProperty(
        value = "amethyst-sunset.enabled",
        havingValue = "true"
)
@RestController
@RequestMapping("/amethyst-sunset")
public class AmethystSunset extends BaseVideoController {
    public AmethystSunset() {
        super(
                new Uploader(
                        new BaseConfigModel(
                                new RedisConfig(0),
                                "amethyst-sunset",
                                "/home/pi/vid-upload/amethyst-sunset/.client_secret.json",
                                "/home/pi/vid-upload/amethyst-sunset/.youtube-upload-credentials.json"
                        )
                )
        );
    }
